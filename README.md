<a href="https://abhijeetpatil-portfolio.netlify.app/" target="_blank" title="My Portfolio" alt="My Portfolio">
 <img src="https://raw.githubusercontent.com/AbhijeetPatil/abhijeetpatilrm/main/Portfolio_Crop_Img.webp" width="100%" height="auto" />
</a>
...
### **SDE - Backend Intern** at **SYNCUP** *(July 2025 - Present)*
- Developing scalable RESTful APIs using Node.js, Express, Prisma ORM, and MongoDB
- Improving data handling efficiency by 30% through optimized backend architecture
- Containerizing services using Docker for streamlined deployment
- Collaborating in Agile sprints for seamless frontend-backend integration

### **Associate Software Developer Intern** at **INFOTACT SOLUTIONS** *(May 2025 - July 2025)*
- Built and deployed two scalable MERN stack web applications
- Integrated JWT authentication, Razorpay payments, and role-based access control
- Engineered real-time hiring platform with geo-based matching
- Selected among top-performing interns for delivering high-impact features
...
- 🗄️ **Database Optimization** with MongoDB and Prisma ORM
- 🔐 **Authentication Systems** with NextAuth.js
- ☁️ **Cloud Deployment** on Vercel and Netlify
...
- **Portfolio**: [abhijeetpatil.netlify.app](https://abhijeetpatil-portfolio.netlify.app)
...
<div align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&color=6366F1&center=true&vCenter=true&width=435&lines=Full+Stack+Developer;React+%7C+Next.js+%7C+Node.js;Building+Amazing+Web+Experiences;Always+Learning+New+Technologies" alt="Typing SVG" />
</div>
